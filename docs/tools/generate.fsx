...
let website = "/aws-s3-cache"

let githubLink = "http://github.com/exira/aws-s3-cache"

// Specify more information about your project
let info =
  [ "project-name", "aws-s3-cache"
    "project-author", "exira"
    "project-summary", "Exira.AwsS3Cache is an IIS module which reads cached objects from AWS S3 and quickly serves them to end users"
